...
const lineData = reactive({
    ...
    datasets: [
        {
            label: 'Ano anterior',
            data: [65, 59, 80, 81, 56, 55, 40, 90, 70, 30, 120, 150],
            fill: false,
        ...
        {
            label: 'Ano Atual',
            data: [28, 48, 40, 19, 86, 27, 90, 90, 95, 100, 150, 200],
            fill: false,
    ...
    <div class="grid">
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                ...
                <span class="text-green-500 font-medium">24 novas vendas </span>
                <span class="text-500">sobre o último mês</span>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                ...
                <span class="text-500">registrados este mês</span>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        ...
                        <div class="text-900 font-medium text-xl">152 criadas</div>
                    </div>
                ...
                <DataTable :value="products" :rows="5" :paginator="true" responsiveLayout="scroll">
                    <Column style="width: 15%">
                        ...
                        <template #body="slotProps">
                            <img :src="'demo/images/product/' + slotProps.data.image" :alt="slotProps.data.image" width="50" height="40" class="shadow-2" />
                        </template>
                    </Column>
                    ...
                    <Column style="width: 15%">
                        <template #header> Detalhar </template>
                        <template #body>
        ...
        <div class="col-12 xl:col-6 sm:col-12">
            <div class="card">
                <h5>Visualização de Vendas</h5>
